...
import br.com.fumaca.mapper.CervejariaMapper;
...
public class CervejaService {
    ...
    @Autowired
    private CervejariaMapper cervejariaMapper;
    ...
    public CervejaResponseDTO salvar(CervejaRequestDTO dto) {
        ...
        entity.setCervejaria(cervejariaMapper.toMinimalDTO(cervejaria)); // usa mapper para encapsular
    ...
    public CervejaResponseDTO alterar(Long id, CervejaRequestDTO dtoAlterado) {
        ...
        if (encontrado.isPresent()) {
            ...
            if (dtoAlterado.getCervejariaId() != null &&
                ...
                cerveja.setCervejaria(cervejariaMapper.toMinimalDTO(novaCervejaria));
            }
